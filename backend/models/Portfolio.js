...
portfolioSchema.pre('save', function(next) {
  ...
  this.grandTotal = this.equity.total + this.nonEquity.total + this.emergency.total;
  ...
  this.invested = stocksInvested + mfInvested + this.nonEquity.totalInvested + this.emergency.totalInvested;
